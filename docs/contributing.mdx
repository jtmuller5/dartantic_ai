---
title: Contributing to dartantic_ai
---

Your contributions to dartantic_ai are welcome! This guide will help you get
started with contributing to the project.

## How to Contribute an Issue

If you have found a bug or have a feature request, please open an issue on the
[GitHub repository](https://github.com/csells/dartantic_ai/issues).
...
To run the full test suite, you'll need API keys for various providers. Set
...
3. **80/20 Rule**: Test common cases across all providers, edge cases on Google
   only
