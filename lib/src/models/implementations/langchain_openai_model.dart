...
/// Langchain-based implementation of [Model] that uses OpenAI's API.
///
/// This model delegates prompt execution to Langchain while maintaining
/// the existing API interface for seamless integration.
class LangchainOpenAiModel extends Model {
  /// Creates a new [LangchainOpenAiModel] with the given parameters.
